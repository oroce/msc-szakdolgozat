...
Természetesen ennek a bevezetése is sokáig eltarthat, hiszen lehet, hogy a szervezet tagjai chaten sem fogják elküldeni az üzenetet a robotnak arról, hogy megérkeztek, mint ahogy a célszoftverbe se lépnének be, viszont míg a be nem jelentkezés esetén a szoftver esetleg emailt tud küldeni vagy a felettest tudja értesíti addig a robot sokkal jobb felhasználói élmény biztosítása mellett képes ezt megtenni, \aref{lst:workhour_with_hubot_ux} ábrán ezt lehet megtekinteni. Mivel a chat a kommunikáció központi forrása, ezért a robotnak egyszerűen a felhasználók cselekvéseit kell figyelemmel követnie és azokra reagálnia.
